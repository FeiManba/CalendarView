...
public abstract class BaseView extends View implements View.OnClickListener, View.OnLongClickListener {
    ...
    com.feima.calendar.CalendarViewDelegate mDelegate;
     ...
     * 日历项
     */
    List<com.feima.calendar.Calendar> mItems;
    ...
    private void initPaint(Context context) {
        ...
        mCurMonthTextPaint.setTextSize(com.feima.calendar.CalendarUtil.dipToPx(context, TEXT_SIZE));
        ...
        mOtherMonthTextPaint.setTextSize(com.feima.calendar.CalendarUtil.dipToPx(context, TEXT_SIZE));
        ...
        mSchemeTextPaint.setTextSize(com.feima.calendar.CalendarUtil.dipToPx(context, TEXT_SIZE));
        ...
        mSelectTextPaint.setTextSize(com.feima.calendar.CalendarUtil.dipToPx(context, TEXT_SIZE));
        ...
        mCurDayTextPaint.setTextSize(com.feima.calendar.CalendarUtil.dipToPx(context, TEXT_SIZE));
        ...
        mCurDayLunarTextPaint.setTextSize(com.feima.calendar.CalendarUtil.dipToPx(context, TEXT_SIZE));
   ...
   final void setup(com.feima.calendar.CalendarViewDelegate delegate) {
    ...
    final void removeSchemes() {
        for (com.feima.calendar.Calendar a : mItems) {
            a.setScheme("");
            a.setSchemeColor(0);
            a.setSchemes(null);
        }
    ...
    final void addSchemesFromMap() {
        ...
        for (com.feima.calendar.Calendar a : mItems) {
            if (mDelegate.mSchemeDatesMap.containsKey(a.toString())) {
                com.feima.calendar.Calendar d = mDelegate.mSchemeDatesMap.get(a.toString());
                if(d == null){
                    continue;
                }
     ...
     */
    protected boolean isSelected(com.feima.calendar.Calendar calendar) {
     ...
     * @return 是否拦截日期
     */
    protected final boolean onCalendarIntercept(com.feima.calendar.Calendar calendar) {
     ...
     * @return 是否在日期范围内
     */
    protected final boolean isInRange(com.feima.calendar.Calendar calendar) {
        return mDelegate != null && com.feima.calendar.CalendarUtil.isCalendarInRange(calendar, mDelegate);
    }
