...
public class DefaultYearView extends YearView {
    ...
    public DefaultYearView(Context context) {
        super(context);
        mTextPadding = com.feima.calendar.CalendarUtil.dipToPx(context, 3);
    }
    ...
    @Override
    protected boolean onDrawSelected(Canvas canvas, com.feima.calendar.Calendar calendar, int x, int y, boolean hasScheme) {
        return false;
    }

    @Override
    protected void onDrawScheme(Canvas canvas, com.feima.calendar.Calendar calendar, int x, int y) {

    }

    @Override
    protected void onDrawText(Canvas canvas, com.feima.calendar.Calendar calendar, int x, int y, boolean hasScheme, boolean isSelected) {
