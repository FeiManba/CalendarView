...
public final class WeekViewPager extends ViewPager {
    ...
    private void init() {
        mWeekCount = com.feima.calendar.CalendarUtil.getWeekCountBetweenBothCalendar(
        ...
        addOnPageChangeListener(new OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (view != null) {
                    view.performClickCalendar(mDelegate.getSelectMode() != com.feima.calendar.CalendarViewDelegate.SELECT_MODE_DEFAULT ?
     ...
     * @return 获取当前周数据
     */
    List<com.feima.calendar.Calendar> getCurrentWeekCalendars() {
        List<com.feima.calendar.Calendar> calendars = com.feima.calendar.CalendarUtil.getWeekCalendars(mDelegate.mIndexCalendar,
                mDelegate);
    ...
    void updateRange() {
        ...
        int i = com.feima.calendar.CalendarUtil.getWeekFromDayInMonth(calendar, mDelegate.getWeekStart());
    ...
    void scrollToCalendar(int year, int month, int day, boolean smoothScroll, boolean invokeListener) {
        ...
        com.feima.calendar.LunarCalendar.setupLunarCalendar(calendar);
    ...
    void scrollToCurrent(boolean smoothScroll) {
        isUsingScrollToCalendar = true;
        int position = com.feima.calendar.CalendarUtil.getWeekFromCalendarStartWithMinCalendar(mDelegate.getCurrentDay(),
                mDelegate.getMinYear(),
                mDelegate.getMinYearMonth(),
                mDelegate.getMinYearDay(),
        ...
        int i = com.feima.calendar.CalendarUtil.getWeekFromDayInMonth(mDelegate.getCurrentDay(), mDelegate.getWeekStart());
        mParentLayout.updateSelectWeek(i);
    }
     ...
     * 更新任意一个选择的日期
     */
    void updateSelected(com.feima.calendar.Calendar calendar, boolean smoothScroll) {
        int position = com.feima.calendar.CalendarUtil.getWeekFromCalendarStartWithMinCalendar(calendar,
                mDelegate.getMinYear(),
                mDelegate.getMinYearMonth(),
                mDelegate.getMinYearDay(),
                mDelegate.getWeekStart()) - 1;
    ...
    private class WeekViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            com.feima.calendar.Calendar calendar = com.feima.calendar.CalendarUtil.getFirstCalendarStartWithMinCalendar(mDelegate.getMinYear(),
                    mDelegate.getMinYearMonth(),
                    mDelegate.getMinYearDay(),
                    position + 1,
                    mDelegate.getWeekStart());
