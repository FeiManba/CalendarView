...
public abstract class YearView extends View {
    ...
    final void init(int year, int month) {
        mYear = year;
        mMonth = month;
        mNextDiff = com.feima.calendar.CalendarUtil.getMonthEndDiff(mYear, mMonth, mDelegate.getWeekStart());
        int preDiff = com.feima.calendar.CalendarUtil.getMonthViewStartDiff(mYear, mMonth, mDelegate.getWeekStart());

        mItems = com.feima.calendar.CalendarUtil.initCalendarForMonthView(mYear, mMonth, mDelegate.getCurrentDay(), mDelegate.getWeekStart());
     ...
     * @param d        d
     */
    private void draw(Canvas canvas, com.feima.calendar.Calendar calendar, int i, int j, int d) {
     ...
     * @param y        日历Card y起点坐标
     */
    protected abstract void onDrawScheme(Canvas canvas, com.feima.calendar.Calendar calendar, int x, int y);
