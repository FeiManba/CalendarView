 ...
 */
public abstract class RangeMonthView extends com.feima.calendar.BaseMonthView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mLineCount; i++) {
            for (int j = 0; j < 7; j++) {
                com.feima.calendar.Calendar calendar = mItems.get(d);
                if (mDelegate.getMonthViewShowMode() == com.feima.calendar.CalendarViewDelegate.MODE_ONLY_CURRENT_MONTH) {
                ...
                } else if (mDelegate.getMonthViewShowMode() == com.feima.calendar.CalendarViewDelegate.MODE_FIT_MONTH) {
                    if (d >= count) {
                        return;
                    }
                }
     ...
     * @param j        j
     */
    private void draw(Canvas canvas, com.feima.calendar.Calendar calendar, int i, int j) {
     ...
     * @return 日历是否被选中
     */
    protected boolean isCalendarSelected(com.feima.calendar.Calendar calendar) {
    ...
    public void onClick(View v) {
        ...
        com.feima.calendar.Calendar calendar = getIndex();
        ...
        if (mDelegate.mSelectedStartRangeCalendar != null && mDelegate.mSelectedEndRangeCalendar == null) {
            int minDiffer = com.feima.calendar.CalendarUtil.differ(calendar, mDelegate.mSelectedStartRangeCalendar);
            if (minDiffer >= 0 && mDelegate.getMinSelectRange() != -1 && mDelegate.getMinSelectRange() > minDiffer + 1) {
                ...
                return;
                    ...
                    com.feima.calendar.CalendarUtil.differ(calendar, mDelegate.mSelectedStartRangeCalendar) + 1) {
                if (mDelegate.mCalendarRangeSelectListener != null) {
        ...
        if (mParentLayout != null) {
            if (calendar.isCurrentMonth()) {
                ...
                mParentLayout.updateSelectWeek(com.feima.calendar.CalendarUtil.getWeekFromDayInMonth(calendar, mDelegate.getWeekStart()));
            }
        }
        if (mDelegate.mCalendarRangeSelectListener != null) {
     ...
     * @return 上一个日期是否选中
     */
    protected final boolean isSelectPreCalendar(com.feima.calendar.Calendar calendar) {
        com.feima.calendar.Calendar preCalendar = com.feima.calendar.CalendarUtil.getPreCalendar(calendar);
     ...
     * @return 下一个日期是否选中
     */
    protected final boolean isSelectNextCalendar(com.feima.calendar.Calendar calendar) {
        com.feima.calendar.Calendar nextCalendar = com.feima.calendar.CalendarUtil.getNextCalendar(calendar);
     ...
     */
    protected abstract boolean onDrawSelected(Canvas canvas, com.feima.calendar.Calendar calendar, int x, int y, boolean hasScheme,
     ...
     */
    protected abstract void onDrawScheme(Canvas canvas, com.feima.calendar.Calendar calendar, int x, int y, boolean isSelected);
     ...
     * @param isSelected 是否选中
     */
    protected abstract void onDrawText(Canvas canvas, com.feima.calendar.Calendar calendar, int x, int y, boolean hasScheme, boolean isSelected);
}
