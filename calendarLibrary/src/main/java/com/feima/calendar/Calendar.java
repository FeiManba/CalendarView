...
public final class Calendar implements Serializable, Comparable<Calendar> {
     ...
     * 获取完整的农历日期
     */
    private com.feima.calendar.Calendar lunarCalendar;
    ...
    public com.feima.calendar.Calendar getLunarCalendar() {
        return lunarCalendar;
    }

    public void setLunarCalendar(com.feima.calendar.Calendar lunarCakendar) {
     ...
     * @return 是否是相同月份
     */
    public boolean isSameMonth(com.feima.calendar.Calendar calendar) {
     ...
     * @return -1 0 1
     */
    public int compareTo(com.feima.calendar.Calendar calendar) {
        if (calendar == null) {
            return 1;
        }
     ...
     * @return 运算差距多少天
     */
    public final int differ(com.feima.calendar.Calendar calendar) {
        return com.feima.calendar.CalendarUtil.differ(this, calendar);
    }
    ...
    public boolean equals(Object o) {
        if (o != null && o instanceof com.feima.calendar.Calendar) {
            if (((com.feima.calendar.Calendar) o).getYear() == year && ((com.feima.calendar.Calendar) o).getMonth() == month && ((com.feima.calendar.Calendar) o).getDay() == day)
                return true;
        }
...
//    }
    ...
    final void mergeScheme(com.feima.calendar.Calendar calendar, String defaultScheme) {
        if (calendar == null)
            return;
