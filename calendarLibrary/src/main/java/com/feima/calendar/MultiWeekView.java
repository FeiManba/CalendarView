...
public abstract class MultiWeekView extends BaseWeekView {
    ...
    protected final boolean isSelectPreCalendar(Calendar calendar) {
        Calendar preCalendar = com.feima.calendar.CalendarUtil.getPreCalendar(calendar);
    ...
    protected final boolean isSelectNextCalendar(Calendar calendar) {
        Calendar nextCalendar = com.feima.calendar.CalendarUtil.getNextCalendar(calendar);
