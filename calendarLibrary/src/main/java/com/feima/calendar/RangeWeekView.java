...
public abstract class RangeWeekView extends BaseWeekView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            onLoopStart(x);
            com.feima.calendar.Calendar calendar = mItems.get(i);
     ...
     */
    protected abstract boolean onDrawSelected(Canvas canvas, com.feima.calendar.Calendar calendar, int x, boolean hasScheme,
     ...
     */
    protected abstract void onDrawScheme(Canvas canvas, com.feima.calendar.Calendar calendar, int x, boolean isSelected);
     ...
     * @param isSelected 是否选中
     */
    protected abstract void onDrawText(Canvas canvas, com.feima.calendar.Calendar calendar, int x, boolean hasScheme, boolean isSelected);
}
