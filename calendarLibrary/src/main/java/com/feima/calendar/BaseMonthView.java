...
public abstract class BaseMonthView extends BaseView {
    ...
    final void initMonthWithDate(int year, int month) {
        ...
        mMonth = month;
        initCalendar();
        mHeight = com.feima.calendar.CalendarUtil.getMonthViewHeight(year, month, mItemHeight, mDelegate.getWeekStart(),
    ...
    private void initCalendar() {
        ...
        int monthDayCount = com.feima.calendar.CalendarUtil.getMonthDaysCount(mYear, mMonth);
    ...
    final void updateShowMode() {
        mLineCount = com.feima.calendar.CalendarUtil.getMonthViewLineCount(mYear, mMonth,
                mDelegate.getWeekStart(),mDelegate.getMonthViewShowMode());
        mHeight = com.feima.calendar.CalendarUtil.getMonthViewHeight(mYear, mMonth, mItemHeight, mDelegate.getWeekStart(),
                mDelegate.getMonthViewShowMode());
        invalidate();
    }
